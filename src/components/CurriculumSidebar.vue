  ...
  <div class="curriculum-sidebar__wrapper has-background-grey-darkest is-flex">
    ...
    <div class="curriculum-sidebar__sections">
      ...
      <div class="curriculum-sidebar__education">
        <div
          class="curriculum-sidebar__education-item mb-1 pb-3"
          v-for="(formation, i) in education"
          :key="i"
        >
          <p class="curriculum-sidebar__education-date">{{ formation.date }}</p>
          <b
            ><p class="curriculum-sidebar__education-name">
              {{ formation.name }}
            </p></b
          >
          <p class="curriculum-sidebar__education-degree">
            {{ formation.degree }}
          </p>
        </div>
      </div>
    ...
    <div class="curriculum-sidebar__sections mt-3">
      ...
      <div class="curriculum-sidebar__education">
        ...
        >
          <b
            ><p class="curriculum-sidebar__education-date">
              {{ course.name }}
            </p></b
          >
          <p class="curriculum-sidebar__education-name">
