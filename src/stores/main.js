...
export const useMainStore = defineStore("mainStore", {
  state: () => ({
    jobs: [
      {
        ...
        position: "Front End Software Engineer | Design System Lead Developer",
      ...
      },
      {
        ...
        description: 
          `Desenvolvedor Front End alocado na empresa Dell Technologies. 
          
          Trabalhei no projeto Dell Financial Services, atuando no Front End do projeto e no processo de legar a plataforma antiga por um projeto novo mais robusto.`,
      ...
      },
      {
        ...
        description: 
          `Comecei como estagiário como Desenvolvedor Full Stack. 

          No desenvolvimento Front End trabalhei com o site da 21Mobile, e desenvolvi landing pages em conjunto com o departamento de marketing. Também tive contato com as ferramentas de Back End utilizadas, como Node, PHP e banco de dados MongoDB e Postgres.`,
    ...
    skills: ["Front End", "Desenvolvimento ágil", "Design System", "Responsividade", "React", "Vue"],
    courses: [
      {
    ...
    profile: 
      ...
      Larga experiência com Design System e experiência com back end
